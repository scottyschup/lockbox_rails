...
describe LockboxPartners::NotesController do
  ...
  let(:user_generated_note) do
    FactoryBot.create(:note, notable: support_request, text: 'old text', user: user)
  end

  let(:other_user_generated_note) do
  ...
  describe '#edit' do
    ...
    context 'when the note was user-generated by other user' do
      let(:note) { other_user_generated_note }
